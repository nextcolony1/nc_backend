...
--
-- Host: localhost
-- Generation Time: Apr 23, 2019 at 12:16 PM
...
INSERT INTO `shop` (`id`, `name`, `itemid`, `prefix`, `tradeble`, `activateable`, `sales_per_day`, `apply_to`, `price`, `duration`, `ore`, `coal`, `copper`, `uranium`, `boost_percentage`) VALUES
(4, 'Rune', 'booster_01', 'B1-', 1, 1, 4, 'planet', 99, NULL, NULL, NULL, NULL, NULL, 10),
(5, 'Mighty Rune', 'booster_02', 'B2-', 1, 1, 2, 'planet', 239, NULL, NULL, NULL, NULL, NULL, 25),
(6, 'Holy Rune', 'booster_03', 'B3-', 1, 1, 1, 'planet', 449, NULL, NULL, NULL, NULL, NULL, 50),
(1, 'Chest', 'chest_01', 'C1-', 1, 1, 100, 'planet', 9.99, NULL, 400, 800, 200, 100, NULL),
(2, 'Huge Chest', 'chest_02', 'C2-', 1, 1, 50, 'planet', 49, NULL, 2000, 4000, 1000, 500, NULL),
(3, 'Imperium Chest', 'chest_03', 'C3-', 1, 1, 30, 'planet', 99, NULL, 4400, 8800, 2200, 1100, NULL);
...
CREATE TABLE `transactions` (
  ...
  `tr_var2` varchar(256) NOT NULL,
  `tr_var3` varchar(256) NOT NULL,
...
(223, 'crovette', 1, 1736, 2430, 1042, 347, 38278),
