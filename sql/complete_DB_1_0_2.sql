...
--
-- Host: localhost
-- Generation Time: Apr 28, 2019 at 07:02 AM
...
INSERT INTO `shipstats` (`id`, `name`, `level`, `speed`, `consumption`, `attack`, `defense`, `guns`, `capacity`, `shipyard_level`) VALUES
(1, 'transportship', 1, 2, 0.002, 0, 3, 0, 100, 12),
(2, 'explorership', 1, 1, 0.002, 0, 1, 0, 0, 13),
(3, 'corvette', 1, 8, 1, 2, 4, 1, 0, 14),
(4, 'frigate', 1, 7, 2, 2, 8, 2, 0, 15),
(5, 'destroyer', 1, 6, 2, 2, 15, 4, 0, 16),
(6, 'cruiser', 1, 5, 3, 2, 20, 8, 0, 17),
(7, 'battlecruiser', 1, 4, 4, 3, 30, 12, 0, 18),
(8, 'carrier', 1, 3, 4, 4, 50, 20, 0, 19),
(9, 'dreadnought', 1, 2, 5, 5, 100, 30, 0, 20);
...
INSERT INTO `shop` (`id`, `name`, `itemid`, `prefix`, `tradeble`, `activateable`, `sales_per_day`, `max_supply`, `apply_to`, `price`, `duration`, `ore`, `coal`, `copper`, `uranium`, `boost_percentage`) VALUES
(4, 'Rune', 'booster_01', 'B1-', 1, 1, 4, 500, 'planet', 99, NULL, NULL, NULL, NULL, NULL, 10),
(5, 'Mighty Rune', 'booster_02', 'B2-', 1, 1, 2, 250, 'planet', 239, NULL, NULL, NULL, NULL, NULL, 25),
(6, 'Holy Rune', 'booster_03', 'B3-', 1, 1, 1, 100, 'planet', 449, NULL, NULL, NULL, NULL, NULL, 50),
(1, 'Chest', 'chest_01', 'C1-', 1, 1, 150, NULL, 'planet', 9.99, NULL, 400, 800, 200, 100, NULL),
(2, 'Huge Chest', 'chest_02', 'C2-', 1, 1, 40, NULL, 'planet', 49, NULL, 2000, 4000, 1000, 500, NULL),
(3, 'Imperium Chest', 'chest_03', 'C3-', 1, 1, 25, NULL, 'planet', 99, NULL, 4400, 8800, 2200, 1100, NULL);
...
INSERT INTO `translate` (`id`, `variable`, `translation`, `lang`) VALUES
(1, 'base', 'Base', 'eng'),
...
(3, 'shipyard', 'Shipyard', 'eng'),
(4, 'shipyard_desc', 'In the spaceships shipyard, you can build spaceships for exploration and transport. With the increasing level of the shipyard you can build mighty warships, which can be used to defend your colony but also to attack your enemies.\r\n', 'eng'),
(5, 'researchcenter', 'Research Center', 'eng'),
(6, 'researchcenter_desc', 'Research involves the exploration of a planet, its immediate environment, the solar system and the universe through to the development of satellite-based technologies. This is where all scientific astronomical and planetary data from all missions converge and where interplanetary space in orbit is monitored.\r\n', 'eng'),
(7, 'coalmine', 'Coal Mine', 'eng'),
(8, 'coalmine_desc', 'The raw material coal is used as a solid fuel to generate heat by combustion. Coal is also used to generate electrical energy. Also needed for the production of plastics and is used in many ways. Coal is a relatively cheap raw material, but it is used for almost all buildings and in large quantities.', 'eng'),
(9, 'oremine', 'Ore Mine', 'eng'),
(10, 'oremine_desc', 'Ore is needing for the production of steel. It\'s indispensable for the expansion of your colony and for construction of buildings and ships. Ore is a cheap raw material, but you need it almost for all buildings in large quantities.', 'eng'),
(11, 'coppermine', 'Copper Mine', 'eng'),
(12, 'coppermine_desc', 'Copper is a soft and ductile semi-precious metal with excellent electrical and thermal conductivity. In addition, copper is resistant to corrosion. Copper is therefore ideally suited for the construction of ships and buildings. Copper is a coveted raw material and it is needed in many buildings and in relatively large quantities.', 'eng'),
(13, 'uraniummine', 'Uranium Mine', 'eng'),
(14, 'coaldepot', 'Coal Depot', 'eng'),
(15, 'coaldepot_desc', 'Coal is relatively uncomplicated to store. However, care must be taken that no flammable materials are storing nearby. The storage of coal is therefore proportionally personnel and cost effective. If your warehouse is full, your colony has to destroy the overproduction. In addition, a depot protects you from plunderers.', 'eng'),
(16, 'oredepot', 'Ore Depot', 'eng'),
(17, 'oredepot_desc', 'Iron ore is stored dry and at low temperatures. It\'s not exposing to increased humidity. In addition, the warehouse should be turning over regularly, otherwise, the iron ore is going to discolor. If your warehouse is full, your colony has to destroy the overproduction. In addition, a depot protects you from plunderers.', 'eng'),
(18, 'copperdepot', 'Copper Depot', 'eng'),
(19, 'copperdepot_desc', 'Copper must be stored free of any air humidity. Therefore the copper warehouse is placed under vacuum. This assures that there is no humidity in the warehouse and that no oxide is formed. If your warehouse is full, your colony has to destroy the overproduction. In addition, a depot protects you from plunderers.', 'eng'),
(20, 'uraniumdepot', 'Uranium Depot', 'eng'),
(21, 'uraniumdepot_desc', 'When storing uranium, it should be noted that secondary products are present from the uranium decay series which also emit beta and penetrating gamma rays. The storage of uranium is, therefore, associating with high personnel expenses and costs. If your warehouse is full, your colony has to destroy the overproduction. In addition, a depot protects you from plunderers.', 'eng'),
(22, 'uraniummine_desc', 'Uranium is primarily used for energy generation. Uranium is also the starting material for the construction of nuclear weapons and ignition devices for hydrogen bombs. Especially to moving your fleet you will need large amounts of uranium. Uranium is a rare raw material that plays a strategically important role.', 'eng'),
(23, 'shipyard_note', 'Note: Reduce the build time for ships by +1%', 'eng'),
(24, 'researchcenter_note', 'Note: Nothing special so far.', 'eng'),
(25, 'cost', 'Cost', 'eng'),
(26, 'coal', 'Coal', 'eng'),
(27, 'ore', 'Ore', 'eng'),
(28, 'copper', 'Copper', 'eng'),
(29, 'uranium', 'Uranium', 'eng'),
(30, 'upgrade', 'Upgrade', 'eng'),
(31, 'miss_resources', 'Miss Resources', 'eng'),
(32, 'upgrading', 'Upgrading', 'eng'),
(33, 'buildings', 'Buildings', 'eng'),
(34, 'enhance', 'Enhance', 'eng'),
(35, 'booster', 'Booster', 'eng'),
(36, 'open', 'Open', 'eng'),
(37, 'opening', 'Opening', 'eng'),
(38, 'merge', 'Merge', 'eng'),
(39, 'merging', 'Merging', 'eng'),
(40, 'base_note', 'Note: Reduce the upgrade time for buildings by +1%', 'eng'),
(41, 'research', 'Research Center', 'eng'),
(42, 'explorespace', 'Explore', 'eng'),
(43, 'explorership', 'Explorer', 'eng'),
(44, 'transportship', 'Transporter', 'eng'),
(45, 'transport', 'Transport', 'eng');
...
--
-- AUTO_INCREMENT for table `shipstats`
--
ALTER TABLE `shipstats`
