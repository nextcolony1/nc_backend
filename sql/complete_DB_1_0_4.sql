...
--
-- Host: localhost
-- Generation Time: Jun 16, 2019 at 08:43 AM
...
--
-- Database: `steembattle`
--
CREATE DATABASE IF NOT EXISTS `steembattle` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `steembattle`;
...
--
-- Table structure for table `battleresults`
--

DROP TABLE IF EXISTS `battleresults`;
CREATE TABLE `battleresults` (
  `mission_id` varchar(50) NOT NULL,
  `battle_number` int(11) NOT NULL DEFAULT '1',
  `attacker` varchar(20) NOT NULL,
  `defender` varchar(20) NOT NULL,
  `result` smallint(6) NOT NULL,
  `initial_attacker_ships` varchar(4096) NOT NULL,
  `initial_defender_ships` varchar(4096) NOT NULL,
  `final_attacker_ships` varchar(4096) NOT NULL,
  `final_defender_ships` varchar(4096) NOT NULL,
  `date` datetime NOT NULL,
  `trx_id` varchar(50) NOT NULL,
  `support_mission_id` varchar(50) DEFAULT NULL,
  `coal` float NOT NULL,
  `ore` float NOT NULL,
  `copper` float NOT NULL,
  `uranium` float NOT NULL,
  `cords_hor` int(11) NOT NULL,
  `cords_ver` int(11) NOT NULL,
  `cords_hor_dest` int(11) DEFAULT NULL,
  `cords_ver_dest` int(11) DEFAULT NULL,
  `attacker_shieldregen` float DEFAULT NULL,
  `defender_shieldregen` float DEFAULT NULL,
  `attacker_armorrep` float DEFAULT NULL,
  `defender_armorrep` float DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `missions` (
  ...
  `cords_hor_dest` int(11) DEFAULT NULL,
  `cords_ver_dest` int(11) DEFAULT NULL,
  `ships` varchar(4096) DEFAULT NULL,
...
--
-- Table structure for table `planetlevels`
--

DROP TABLE IF EXISTS `planetlevels`;
...
--
-- Dumping data for table `planetlevels`
--
...
CREATE TABLE `planets` (
  ...
  `shieldprotection_busy` datetime DEFAULT NULL,
  `shieldcharge_busy` datetime DEFAULT NULL,
  `shieldcharged` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `blueprints` varchar(1024) DEFAULT NULL,
...
CREATE TABLE `ranking` (
  ...
  `destroyed_ships` int(11) NOT NULL DEFAULT '0',
  `destroyed_ships_uranium` float NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
('battlecruiser', 'Battlecruiser Tiger', 'Battlecruiser', 0, 'rocket', 1, 2, 0.0038, 40, 20, 36, 8, 0, 0, 160, 18),
('battlecruiser1', 'Battlecruiser Lion', 'Battlecruiser', 1, 'bullet', 1, 2, 0.0038, 40, 20, 36, 0, 8, 0, 160, 18),
('battlecruiser2', 'Battlecruiser Leopard', 'Battlecruiser', 2, 'laser', 1, 2, 0.0038, 40, 20, 36, 0, 0, 8, 160, 18),
('carrier', 'Carrier Argus', 'Carrier', 0, 'rocket', 1, 1, 0.0096, 60, 100, 80, 20, 0, 0, 800, 19),
('carrier1', 'Carrier Unicorn', 'Carrier', 1, 'bullet', 1, 1, 0.0096, 60, 100, 80, 0, 20, 0, 800, 19),
('carrier2', 'Carrier Centaur', 'Carrier', 2, 'laser', 1, 1, 0.0096, 60, 100, 80, 0, 0, 20, 800, 19),
('corvette', 'Corvette Crocus', 'Corvette', 0, 'rocket', 1, 4, 0.001, 6, 8, 10, 2, 0, 0, 20, 14),
('corvette1', 'Corvette Petunia', 'Corvette', 1, 'bullet', 1, 4, 0.001, 6, 8, 10, 0, 2, 0, 20, 14),
('corvette2', 'Corvette Pimpernel', 'Corvette', 2, 'laser', 1, 4, 0.001, 6, 8, 10, 0, 0, 2, 20, 14),
('cruiser', 'Cruiser Kent', 'Cruiser', 0, 'rocket', 1, 2, 0.0024, 15, 25, 20, 5, 0, 0, 100, 17),
('cruiser1', 'Cruiser Drake', 'Cruiser', 1, 'bullet', 1, 2, 0.0024, 15, 25, 20, 0, 5, 0, 100, 17),
('cruiser2', 'Cruiser Hogue', 'Cruiser', 2, 'laser', 1, 2, 0.0024, 15, 25, 20, 0, 0, 5, 100, 17),
('destroyer', 'Destroyer Rocket', 'Destroyer', 0, 'rocket', 1, 3, 0.0018, 12, 14, 16, 4, 0, 0, 50, 16),
('destroyer1', 'Destroyer Janus', 'Destroyer', 1, 'bullet', 1, 3, 0.0018, 12, 14, 16, 0, 4, 0, 50, 16),
('destroyer2', 'Destroyer Banshee', 'Destroyer', 2, 'laser', 1, 3, 0.0018, 12, 14, 16, 0, 0, 4, 50, 16),
('dreadnought', 'Dreadnought Royal', 'Dreadnought', 0, 'rocket', 1, 1, 0.024, 200, 240, 160, 50, 0, 0, 2000, 20),
('dreadnought1', 'Dreadnought Imperial', 'Dreadnought', 1, 'bullet', 1, 1, 0.024, 200, 240, 160, 0, 50, 0, 2000, 20),
('dreadnought2', 'Dreadnought Galactic', 'Dreadnought', 2, 'laser', 1, 1, 0.024, 200, 240, 160, 0, 0, 50, 2000, 20),
('explorer', 'Explorer', 'Explorer', 0, 'civil', 1, 1, 0.002, 80, 20, 20, 0, 0, 0, 0, 13),
('explorership', 'Explorer', 'Explorer', 0, 'civil', 1, 1, 0.002, 80, 20, 20, 0, 0, 0, 0, 13),
('frigate', 'Frigate Quorn', 'Frigate', 0, 'rocket', 1, 3, 0.0014, 12, 16, 8, 3, 0, 0, 40, 15),
('frigate1', 'Frigate Redmill', 'Frigate', 1, 'bullet', 1, 3, 0.0014, 12, 16, 8, 0, 3, 0, 40, 15),
('frigate2', 'Frigate Lasalle', 'Frigate', 2, 'laser', 1, 3, 0.0014, 12, 16, 8, 0, 0, 3, 40, 15),
('transporter', 'Transporter', 'Transporter', 0, 'civil', 1, 2, 0.002, 80, 20, 20, 0, 0, 0, 100, 12),
('transportship', 'Transporter', 'Transporter', 0, 'civil', 1, 2, 0.002, 80, 20, 20, 0, 0, 0, 100, 12);
...
CREATE TABLE `shop` (
  ...
  `uranium` int(11) DEFAULT NULL,
  `boost_percentage` float DEFAULT NULL,
  `blueprint` varchar(256) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `skillcosts`
--
...
--
-- Dumping data for table `skillcosts`
--
...
(561, 'structureimprove', 1, 1536, 640, 499, 160, 61714),
(562, 'structureimprove', 2, 1613, 672, 524, 168, 61714),
(563, 'structureimprove', 3, 1690, 704, 549, 176, 61714),
(564, 'structureimprove', 4, 1766, 736, 478, 221, 61714),
(565, 'structureimprove', 5, 1843, 768, 599, 192, 61714),
(566, 'structureimprove', 6, 1920, 800, 624, 200, 61714),
(567, 'structureimprove', 7, 1997, 832, 649, 208, 61714),
(568, 'structureimprove', 8, 2074, 864, 562, 259, 61714),
(569, 'structureimprove', 9, 2150, 896, 582, 269, 61714),
(570, 'structureimprove', 10, 2227, 928, 724, 232, 61714),
(571, 'structureimprove', 11, 2304, 960, 749, 240, 61714),
(572, 'structureimprove', 12, 2381, 992, 774, 248, 61714),
(573, 'structureimprove', 13, 2949, 1024, 666, 256, 61714),
(574, 'structureimprove', 14, 2534, 1267, 686, 264, 61714),
(575, 'structureimprove', 15, 2611, 1088, 849, 272, 61714),
(576, 'structureimprove', 16, 2688, 1120, 728, 336, 61714),
(577, 'structureimprove', 17, 3318, 1152, 749, 288, 61714),
(578, 'structureimprove', 18, 2842, 1421, 770, 296, 61714),
(579, 'structureimprove', 19, 2918, 1216, 948, 304, 61714),
(580, 'structureimprove', 20, 2995, 1248, 811, 374, 61714),
(581, 'armorimprove', 1, 1280, 768, 499, 160, 61714),
(582, 'armorimprove', 2, 1344, 806, 524, 168, 61714),
(583, 'armorimprove', 3, 1408, 845, 549, 176, 61714),
(584, 'armorimprove', 4, 1472, 883, 478, 221, 61714),
(585, 'armorimprove', 5, 1536, 922, 599, 192, 61714),
(586, 'armorimprove', 6, 1600, 960, 624, 200, 61714),
(587, 'armorimprove', 7, 1664, 998, 649, 208, 61714),
(588, 'armorimprove', 8, 1728, 1037, 562, 259, 61714),
(589, 'armorimprove', 9, 1792, 1075, 582, 269, 61714),
(590, 'armorimprove', 10, 1856, 1114, 724, 232, 61714),
(591, 'armorimprove', 11, 1920, 1152, 749, 240, 61714),
(592, 'armorimprove', 12, 1984, 1190, 774, 248, 61714),
(593, 'armorimprove', 13, 2458, 1229, 666, 256, 61714),
(594, 'armorimprove', 14, 2112, 1521, 686, 264, 61714),
(595, 'armorimprove', 15, 2176, 1306, 849, 272, 61714),
(596, 'armorimprove', 16, 2240, 1344, 728, 336, 61714),
(597, 'armorimprove', 17, 2765, 1382, 749, 288, 61714),
(598, 'armorimprove', 18, 2368, 1705, 770, 296, 61714),
(599, 'armorimprove', 19, 2432, 1459, 948, 304, 61714),
(600, 'armorimprove', 20, 2496, 1498, 811, 374, 61714),
(601, 'shieldimprove', 1, 1280, 640, 461, 192, 61714),
(602, 'shieldimprove', 2, 1344, 672, 484, 202, 61714),
(603, 'shieldimprove', 3, 1408, 704, 507, 211, 61714),
(604, 'shieldimprove', 4, 1472, 736, 442, 265, 61714),
(605, 'shieldimprove', 5, 1536, 768, 553, 230, 61714),
(606, 'shieldimprove', 6, 1600, 800, 576, 240, 61714),
(607, 'shieldimprove', 7, 1664, 832, 599, 250, 61714),
(608, 'shieldimprove', 8, 1728, 864, 518, 311, 61714),
(609, 'shieldimprove', 9, 1792, 896, 538, 323, 61714),
(610, 'shieldimprove', 10, 1856, 928, 668, 278, 61714),
(611, 'shieldimprove', 11, 1920, 960, 691, 288, 61714),
(612, 'shieldimprove', 12, 1984, 992, 714, 298, 61714),
(613, 'shieldimprove', 13, 2458, 1024, 614, 307, 61714),
(614, 'shieldimprove', 14, 2112, 1267, 634, 317, 61714),
(615, 'shieldimprove', 15, 2176, 1088, 783, 326, 61714),
(616, 'shieldimprove', 16, 2240, 1120, 672, 403, 61714),
(617, 'shieldimprove', 17, 2765, 1152, 691, 346, 61714),
(618, 'shieldimprove', 18, 2368, 1421, 710, 355, 61714),
(619, 'shieldimprove', 19, 2432, 1216, 876, 365, 61714),
(620, 'shieldimprove', 20, 2496, 1248, 749, 449, 61714),
(621, 'rocketimprove', 1, 1536, 640, 499, 160, 61714),
(622, 'rocketimprove', 2, 1597, 666, 519, 166, 61714),
(623, 'rocketimprove', 3, 1659, 691, 539, 173, 61714),
(624, 'rocketimprove', 4, 1720, 717, 466, 215, 61714),
(625, 'rocketimprove', 5, 1782, 742, 579, 186, 61714),
(626, 'rocketimprove', 6, 1843, 768, 599, 192, 61714),
(627, 'rocketimprove', 7, 1905, 794, 619, 198, 61714),
(628, 'rocketimprove', 8, 1966, 819, 532, 246, 61714),
(629, 'rocketimprove', 9, 2028, 845, 549, 253, 61714),
(630, 'rocketimprove', 10, 2089, 870, 679, 218, 61714),
(631, 'rocketimprove', 11, 2150, 896, 699, 224, 61714),
(632, 'rocketimprove', 12, 2212, 922, 719, 230, 61714),
(633, 'rocketimprove', 13, 2728, 947, 616, 237, 61714),
(634, 'rocketimprove', 14, 2335, 1167, 632, 243, 61714),
(635, 'rocketimprove', 15, 2396, 998, 779, 250, 61714),
(636, 'rocketimprove', 16, 2458, 1024, 666, 307, 61714),
(637, 'rocketimprove', 17, 3023, 1050, 682, 262, 61714),
(638, 'rocketimprove', 18, 2580, 1290, 699, 269, 61714),
(639, 'rocketimprove', 19, 2642, 1101, 859, 275, 61714),
(640, 'rocketimprove', 20, 2703, 1126, 732, 338, 61714),
(641, 'bulletimprove', 1, 1280, 768, 499, 160, 61714),
(642, 'bulletimprove', 2, 1331, 799, 519, 166, 61714),
(643, 'bulletimprove', 3, 1382, 829, 539, 173, 61714),
(644, 'bulletimprove', 4, 1434, 860, 466, 215, 61714),
(645, 'bulletimprove', 5, 1485, 891, 579, 186, 61714),
(646, 'bulletimprove', 6, 1536, 922, 599, 192, 61714),
(647, 'bulletimprove', 7, 1587, 952, 619, 198, 61714),
(648, 'bulletimprove', 8, 1638, 983, 532, 246, 61714),
(649, 'bulletimprove', 9, 1690, 1014, 549, 253, 61714),
(650, 'bulletimprove', 10, 1741, 1044, 679, 218, 61714),
(651, 'bulletimprove', 11, 1792, 1075, 699, 224, 61714),
(652, 'bulletimprove', 12, 1843, 1106, 719, 230, 61714),
(653, 'bulletimprove', 13, 2273, 1137, 616, 237, 61714),
(654, 'bulletimprove', 14, 1946, 1401, 632, 243, 61714),
(655, 'bulletimprove', 15, 1997, 1198, 779, 250, 61714),
(656, 'bulletimprove', 16, 2048, 1229, 666, 307, 61714),
(657, 'bulletimprove', 17, 2519, 1260, 682, 262, 61714),
(658, 'bulletimprove', 18, 2150, 1548, 699, 269, 61714),
(659, 'bulletimprove', 19, 2202, 1321, 859, 275, 61714),
(660, 'bulletimprove', 20, 2253, 1352, 732, 338, 61714),
(661, 'laserimprove', 1, 1280, 640, 461, 192, 61714),
(662, 'laserimprove', 2, 1331, 666, 479, 200, 61714),
(663, 'laserimprove', 3, 1382, 691, 498, 207, 61714),
(664, 'laserimprove', 4, 1434, 717, 430, 258, 61714),
(665, 'laserimprove', 5, 1485, 742, 535, 223, 61714),
(666, 'laserimprove', 6, 1536, 768, 553, 230, 61714),
(667, 'laserimprove', 7, 1587, 794, 571, 238, 61714),
(668, 'laserimprove', 8, 1638, 819, 492, 295, 61714),
(669, 'laserimprove', 9, 1690, 845, 507, 304, 61714),
(670, 'laserimprove', 10, 1741, 870, 627, 261, 61714),
(671, 'laserimprove', 11, 1792, 896, 645, 269, 61714),
(672, 'laserimprove', 12, 1843, 922, 664, 276, 61714),
(673, 'laserimprove', 13, 2273, 947, 568, 284, 61714),
(674, 'laserimprove', 14, 1946, 1167, 584, 292, 61714),
(675, 'laserimprove', 15, 1997, 998, 719, 300, 61714),
(676, 'laserimprove', 16, 2048, 1024, 614, 369, 61714),
(677, 'laserimprove', 17, 2519, 1050, 630, 315, 61714),
(678, 'laserimprove', 18, 2150, 1290, 645, 323, 61714),
(679, 'laserimprove', 19, 2202, 1101, 793, 330, 61714),
(680, 'laserimprove', 20, 2253, 1126, 676, 406, 61714),
(681, 'regenerationbonus', 1, 179, 32, 31, 16, 61714),
(682, 'regenerationbonus', 2, 314, 56, 54, 28, 61714),
(683, 'regenerationbonus', 3, 448, 80, 77, 40, 61714),
(684, 'regenerationbonus', 4, 582, 104, 83, 62, 61714),
(685, 'regenerationbonus', 5, 717, 128, 123, 64, 61714),
(686, 'regenerationbonus', 6, 851, 152, 146, 76, 61714),
(687, 'regenerationbonus', 7, 986, 176, 169, 88, 61714),
(688, 'regenerationbonus', 8, 1120, 200, 160, 120, 61714),
(689, 'regenerationbonus', 9, 1254, 224, 179, 134, 61714),
(690, 'regenerationbonus', 10, 1389, 248, 238, 124, 61714),
(691, 'regenerationbonus', 11, 1523, 272, 261, 136, 61714),
(692, 'regenerationbonus', 12, 1658, 296, 284, 148, 61714),
(693, 'regenerationbonus', 13, 2150, 320, 256, 160, 61714),
(694, 'regenerationbonus', 14, 1926, 413, 275, 172, 61714),
(695, 'regenerationbonus', 15, 2061, 368, 353, 184, 61714),
(696, 'regenerationbonus', 16, 2195, 392, 314, 235, 61714),
(697, 'regenerationbonus', 17, 2796, 416, 333, 208, 61714),
(698, 'regenerationbonus', 18, 2464, 528, 352, 220, 61714),
(699, 'regenerationbonus', 19, 2598, 464, 445, 232, 61714),
(700, 'regenerationbonus', 20, 2733, 488, 390, 293, 61714),
(701, 'repairbonus', 1, 128, 77, 46, 16, 61714),
(702, 'repairbonus', 2, 224, 134, 81, 28, 61714),
(703, 'repairbonus', 3, 320, 192, 115, 40, 61714),
(704, 'repairbonus', 4, 416, 250, 125, 62, 61714),
(705, 'repairbonus', 5, 512, 307, 184, 64, 61714),
(706, 'repairbonus', 6, 608, 365, 219, 76, 61714),
(707, 'repairbonus', 7, 704, 422, 253, 88, 61714),
(708, 'repairbonus', 8, 800, 480, 240, 120, 61714),
(709, 'repairbonus', 9, 896, 538, 269, 134, 61714),
(710, 'repairbonus', 10, 992, 595, 357, 124, 61714),
(711, 'repairbonus', 11, 1088, 653, 392, 136, 61714),
(712, 'repairbonus', 12, 1184, 710, 426, 148, 61714),
(713, 'repairbonus', 13, 1536, 768, 384, 160, 61714),
(714, 'repairbonus', 14, 1376, 991, 413, 172, 61714),
(715, 'repairbonus', 15, 1472, 883, 530, 184, 61714),
(716, 'repairbonus', 16, 1568, 941, 470, 235, 61714),
(717, 'repairbonus', 17, 1997, 998, 499, 208, 61714),
(718, 'repairbonus', 18, 1760, 1267, 528, 220, 61714),
(719, 'repairbonus', 19, 1856, 1114, 668, 232, 61714),
(720, 'repairbonus', 20, 1952, 1171, 586, 293, 61714),
(721, 'shieldgenerator', 1, 8, 4, 2, 1, 945),
(722, 'shieldgenerator', 2, 19, 10, 5, 2, 1991),
(723, 'shieldgenerator', 3, 34, 17, 8, 4, 3153),
(724, 'shieldgenerator', 4, 51, 26, 13, 6, 4454),
(725, 'shieldgenerator', 5, 72, 36, 18, 9, 5918),
(726, 'shieldgenerator', 6, 96, 48, 24, 12, 7579),
(727, 'shieldgenerator', 7, 123, 62, 31, 15, 9480),
(728, 'shieldgenerator', 8, 154, 77, 38, 19, 11676),
(729, 'shieldgenerator', 9, 187, 94, 47, 23, 14242),
(730, 'shieldgenerator', 10, 224, 112, 56, 28, 17280),
(731, 'shieldgenerator', 11, 264, 132, 66, 33, 20934),
(732, 'shieldgenerator', 12, 307, 154, 77, 38, 25412),
(733, 'shieldgenerator', 13, 354, 177, 88, 44, 31028),
(734, 'shieldgenerator', 14, 403, 202, 101, 50, 38278),
(735, 'shieldgenerator', 15, 456, 228, 114, 57, 48000),
(736, 'shieldgenerator', 16, 512, 256, 128, 64, 61714),
(737, 'shieldgenerator', 17, 571, 286, 143, 71, 82517),
(738, 'shieldgenerator', 18, 634, 317, 158, 79, 117818),
(739, 'shieldgenerator', 19, 699, 350, 175, 87, 190884),
(740, 'shieldgenerator', 20, 768, 384, 192, 96, 432000);
...
CREATE TABLE `transactions` (
  ...
  `tr_var1` varchar(1024) NOT NULL,
  `tr_var2` varchar(1024) DEFAULT NULL,
  `tr_var3` varchar(1024) DEFAULT NULL,
  `tr_var4` varchar(1024) DEFAULT NULL,
  `tr_var5` varchar(1024) DEFAULT NULL,
  `tr_var6` varchar(1024) DEFAULT NULL,
  `tr_var7` varchar(1024) DEFAULT NULL,
  `tr_var8` varchar(1024) DEFAULT NULL,
...
--
-- Table structure for table `upgradecosts`
--

DROP TABLE IF EXISTS `upgradecosts`;
...
--
-- Dumping data for table `upgradecosts`
--
...
(223, 'corvette', 1, 112, 56, 28, 17, 38278),
(224, 'frigate', 1, 180, 90, 45, 22, 48000),
(225, 'destroyer', 1, 240, 120, 60, 30, 61714),
(226, 'cruiser', 1, 340, 170, 85, 42, 82516),
(227, 'battlecruiser', 1, 576, 288, 144, 72, 117818),
(228, 'carrier', 1, 1520, 760, 380, 190, 190883),
(229, 'dreadnought', 1, 4000, 2000, 1000, 500, 432000),
...
(270, 'corvette1', 1, 112, 56, 28, 14, 38278),
(271, 'corvette2', 1, 112, 56, 28, 14, 38278),
(272, 'frigate1', 1, 180, 90, 45, 22, 48000),
(273, 'frigate2', 1, 180, 90, 45, 22, 48000),
(274, 'destroyer1', 1, 240, 120, 60, 30, 61714),
(275, 'destroyer2', 1, 240, 120, 60, 30, 61714),
(276, 'dreadnought1', 1, 4000, 2000, 1000, 500, 432000),
(277, 'dreadnought2', 1, 4000, 2000, 1000, 500, 432000),
(278, 'cruiser1', 1, 340, 170, 85, 42, 82516),
(279, 'cruiser2', 1, 340, 170, 85, 42, 82516),
(280, 'battlecruiser1', 1, 576, 288, 144, 72, 117818),
(281, 'battlecruiser2', 1, 576, 288, 144, 72, 117818),
(282, 'carrier1', 1, 1520, 760, 380, 190, 190883),
(283, 'carrier2', 1, 1520, 760, 380, 190, 190883),
(284, 'shieldgenerator', 1, 8, 4, 2, 1, 945),
(285, 'shieldgenerator', 2, 19, 10, 5, 2, 1991),
(286, 'shieldgenerator', 3, 34, 17, 8, 4, 3153),
(287, 'shieldgenerator', 4, 51, 26, 13, 6, 4454),
(288, 'shieldgenerator', 5, 72, 36, 18, 9, 5918),
(289, 'shieldgenerator', 6, 96, 48, 24, 12, 7579),
(290, 'shieldgenerator', 7, 123, 62, 31, 15, 9480),
(291, 'shieldgenerator', 8, 154, 77, 38, 19, 11676),
(292, 'shieldgenerator', 9, 187, 94, 47, 23, 14242),
(293, 'shieldgenerator', 10, 224, 112, 56, 28, 17280),
(294, 'shieldgenerator', 11, 264, 132, 66, 33, 20934),
(295, 'shieldgenerator', 12, 307, 154, 77, 38, 25412),
(296, 'shieldgenerator', 13, 354, 177, 88, 44, 31028),
(297, 'shieldgenerator', 14, 403, 202, 101, 50, 38278),
(298, 'shieldgenerator', 15, 456, 228, 114, 57, 48000),
(299, 'shieldgenerator', 16, 512, 256, 128, 64, 61714),
(300, 'shieldgenerator', 17, 571, 286, 143, 71, 82517),
(301, 'shieldgenerator', 18, 634, 317, 158, 79, 117818),
(302, 'shieldgenerator', 19, 699, 350, 175, 87, 190884),
(303, 'shieldgenerator', 20, 768, 384, 192, 96, 432000);
...
CREATE TABLE `users` (
  ...
  `r_structureimprove` int(11) DEFAULT NULL,
  `r_armorimprove` int(11) DEFAULT NULL,
  `r_shieldimprove` int(11) DEFAULT NULL,
  `r_rocketimprove` int(11) DEFAULT NULL,
  `r_bulletimprove` int(11) DEFAULT NULL,
  `r_laserimprove` int(11) DEFAULT NULL,
  `r_regenerationbonus` int(11) DEFAULT NULL,
  `r_repairbonus` int(11) DEFAULT NULL,
  ...
  `r_structureimprove_busy` datetime DEFAULT NULL,
  `r_armorimprove_busy` datetime DEFAULT NULL,
  `r_shieldimprove_busy` datetime DEFAULT NULL,
  `r_rocketimprove_busy` datetime DEFAULT NULL,
  `r_bulletimprove_busy` datetime DEFAULT NULL,
  `r_laserimprove_busy` datetime DEFAULT NULL,
  `r_regenerationbonus_busy` datetime DEFAULT NULL,
  `r_repairbonus_busy` datetime DEFAULT NULL,
...
--
-- Table structure for table `virtualops`
--

DROP TABLE IF EXISTS `virtualops`;
...
--
-- Indexes for table `battleresults`
--
ALTER TABLE `battleresults`
  ADD PRIMARY KEY (`mission_id`,`battle_number`),
  ADD KEY `ix_battleresults_bc3a20d8b14ceae8` (`mission_id`,`attacker`),
  ADD KEY `ix_battleresults_e8d40331d8f8d78c` (`mission_id`,`battle_number`),
  ADD KEY `support_mission_id` (`support_mission_id`);
...
ALTER TABLE `missions`
  ...
  ADD KEY `busy_until_return` (`busy_until_return`,`cords_hor`,`cords_ver`,`cords_hor_dest`,`cords_ver_dest`),
  ADD KEY `busy_until` (`busy_until`,`cords_hor`,`cords_ver`),
  ADD KEY `busy_until_2` (`busy_until`,`cords_hor_dest`,`cords_ver_dest`);

--
-- Indexes for table `planetlevels`
--
...
ALTER TABLE `ranking`
  ...
  ADD KEY `meta_rate` (`meta_rate`),
  ADD KEY `destroyed_ships_uranium` (`destroyed_ships_uranium`);
...
--
-- Indexes for table `upgradecosts`
--
...
ALTER TABLE `virtualops`
  ...
  ADD KEY `mission_id` (`mission_id`);
  ADD KEY `date` (`date`,`trigger_date`,`tr_status`);
...
--
-- AUTO_INCREMENT for table `planetlevels`
--
ALTER TABLE `planetlevels`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `planettypes`
--
ALTER TABLE `planettypes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT for table `skillcosts`
--
ALTER TABLE `skillcosts`
...
--
-- AUTO_INCREMENT for table `upgradecosts`
--
ALTER TABLE `upgradecosts`
...
--
-- AUTO_INCREMENT for table `virtualops`
--
ALTER TABLE `virtualops`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
